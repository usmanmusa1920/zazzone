...
class UserAdminForm(UserAdmin):
    ...
    fieldsets = (
        ...
        ('Permissions', {"fields": ('is_active', 'is_verified', 'is_superuser', 'is_staff',
         'is_admin', 'is_num_encrypt', 'is_email_encrypt', 'is_dob_encrypt',)}),
        ('Personal', {"fields": ('image', 'first_name', 'last_name',
         'gender', 'date_of_birth', 'country', 'friends',)}),
